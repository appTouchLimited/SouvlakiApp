...
public class drawer_frag_three extends Fragment {
    public static drawer_frag_three newInstance() {
        drawer_frag_three fragment = new drawer_frag_three();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myView = inflater.inflate(R.layout.drawer_frag_three, container, false);
        ...
        mFirebaseRemoteConfig.fetch(cacheExpiration)
                .addOnCompleteListener(getActivity(), new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                      ...
                      /*      Toast.makeText(getActivity(), "Drawer Three",
